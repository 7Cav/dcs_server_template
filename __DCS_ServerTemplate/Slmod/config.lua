...
--[=[If the admin tools are enabled, then this variable matters.  
    ...
    -- admin_tools_mission_folder = [[C:\Users\---\My Drive\SLMOD MISSIONS\]]
...
autoAdmin.autoKickEnabled = false

--[[Set autoAdmin.autoSpecEnable to true below to enable auto kicking to spectator]]
autoAdmin.autoSpecEnabled = true -- !Important! - Disable for training servers
...
autoAdmin.MOTD_show_settings = true
...
--[[Enter your custom MOTD here.  It replaces the first line of the default MOTD.]]
    custom_MOTD = "Welcome to our 7Cav Server. Make sure you join us on discord @ https://discord.gg/7cav"
