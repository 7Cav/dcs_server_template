...
local tacviewBookmarkShortcut = DbOption.new():setValue(0):combo({
										...
										DbOption.Item(_("AltGr + B")):Value(3),
...
local tacviewPlaybackDelay = DbOption.new():setValue(10*60):combo({
										DbOption.Item(_("`")):Value(0),		-- no delay
										DbOption.Item(_("`")):Value(1*60),	-- 1 min
										DbOption.Item(_("`")):Value(2*60),	-- 2 min
										DbOption.Item(_("`")):Value(5*60),	-- 5 min
										DbOption.Item(_("`")):Value(10*60),	-- 10 min
										DbOption.Item(_("`")):Value(20*60),	-- 20 min
										DbOption.Item(_("`")):Value(30*60),	-- 30 min
										})
...
local tacviewExportPath = DbOption.new():setValue(""):editbox()
...
return
{
	...
	tacviewPlaybackDelay				= tacviewPlaybackDelay,
	...
	tacviewExportPath					= tacviewExportPath,
}
